...
Применяю знания с годичного курса по пентесту для выявления и эксплуатации уязвимостей в веб-приложениях и корпоративных сетях (Active Directory).  

**🔭 В настоящий момент:**
- Ищу возможности для **стажировки** или участия в **Bug Bounty**-программах.
- Открыт для сотрудничества в **OSINT**-проектах.
- Активно практикуюсь на **TryHackMe** (67+ завершённых комнат).

**🛠️ Ключевые компетенции:**
- Владение **OSINT**-методиками.
- Настройка **LM Studio** для запуска локальных LLM.
- Развёртывание виртуальных машин под любые задачи.
